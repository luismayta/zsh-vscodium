...
To contribute to zsh-vscodium project on [GitHub](https://github.com/luismayta/zsh-vscodium), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-vscodium/pulls).
...
To follow the instructions in this guide and start contributing to zsh-vscodium project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-vscodium.git
```

Now your **upstream** points to **luismayta/zsh-vscodium**.
...
git fetch upstream # assuming upstream is luismayta/zsh-vscodium
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-vscodium/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
