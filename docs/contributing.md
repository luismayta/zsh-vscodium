<!-- Space: Projects -->
<!-- Parent: ZshVscodium -->
<!-- Title: Contributing ZshVscodium -->
<!-- Label: ZshVscodium -->
<!-- Label: Contributing -->
...
- Contribute to zsh-vscodium repositories on [GitHub](https://github.com/luismayta/zsh-vscodium). See [GitHub flow](./contribute/github-flow.md).
...
Documentation is a part of the zsh-vscodium code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/luismayta/zsh-vscodium). This means that the contribution process is the same for both the source code and documentation.
...
1.  See if a [Pull Request](https://github.com/luismayta/zsh-vscodium/pulls) exists
    - Add some comments or review the code to help it along
    - Don\'t be afraid to comment when logic needs clarification
2.  Create a Fork and open a [Pull Request](https://github.com/luismayta/zsh-vscodium/pulls) if needed

### Code Review

- Anyone can review code
- Any [Pull Request](https://github.com/luismayta/zsh-vscodium/pulls) should be closed or merged within a week
